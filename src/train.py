...
from src.datasets.abcd import make_abcd  # output of Dataset should be {'fmri': tensor (1, n_rois, seq_length)}
...
def main(args, resume_preempt=False):
    ...
    _, unsupervised_loader, unsupervised_sampler = make_abcd(
            ...
            ts_path=args['data']['ts_path'],
            metadata_path=args['data']['metadata_path'],
            split=args['data'].get('split', 'train'),
            val_frac=args['data'].get('val_frac', 0.1),
            test_frac=args['data'].get('test_frac', 0.1),
            split_seed=args['data'].get('split_seed', 0),
            subject_col=args['data'].get('subject_col', 'src_subject_id'),
            n_rois=crop_size[0],
            seq_length=crop_size[1])
